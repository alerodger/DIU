...
| ------------- | -------- | ----------- | ----------- | -----------  | ---------- | ----
| Javier  | H / 24   | Estudiante  | Avanzada       | Introvertido | Web.       | A 
| Josefina  | M / 34   | Turista  | Media       | Racional       | Web        | A 
| Francisca  | M / 52   | Aparejadora     | Baja        | Emocional    |Web      | B 
| Pedro  | H / 19   | Estudiante  | Avanzada       | Extrovertido     | Web        | B 
